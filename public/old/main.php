  ...
  <body class="skin-blue sidebar-mini">
            ...
            <div class="col-xs-12">
              <div class="box">
                ...
                <?php
                    ...
                    if($_GET['show'] == 'distribution'){
                        $all = Guests::getByDistribution($_GET['id']);
                        if($_GET['table']){
                            $all = Guests::getByDistributionTable($_GET['id'], $_GET['table']);
                        }
                        //echo '<script>$(document).ready(function(){setTimeout(refresh, 3000);})</script>';
                        $class="hide";
                        $api = 'distribution';
    ...
    <script>
        function apiCall() {
            ...
            $.ajax({
                url:'api.php',
                data: {call: theApi, id: <?=$_GET['id']?>, table: <?=$_GET['table']?>},
                type: 'post',
